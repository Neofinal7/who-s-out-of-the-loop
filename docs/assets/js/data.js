...
// ════════════════════════════════════════════════════════════════
const TWISTS=[
 {id:'word_swap',emoji:'🔄',title:{ar:'تبادل الكلمات!',en:'Word Swap!'},desc:{ar:'لاعبان يتبادلان الكلمات، ومن بعدها كل واحد يلعب بالكلمة الجديدة.',en:'Two players exchange words, and each one must play as the new word from then on.'}},
