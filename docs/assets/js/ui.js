...
function renderRulesModal(){
 ...
 const sections=ar?[
  ...
  },
  {
   ...
   t:'التحديات',
   items:[
    {e:'⏱️',t:'متى تطلع؟',d:'إذا كانت التحديات مفعّلة، اللعبة تسند 1 إلى 3 تحديات عشوائية حسب عدد اللاعبين.'},
    {e:'🧠',t:'كيف تطلع؟',d:'التحديات ممكن تطلع قبل الكلمات أو أثناء الأسئلة، والاختيار عشوائي مع تقليل التكرار الواضح قدر الإمكان.'},
  ...
  },
  {
   ...
   t:'Twists',
   items:[
    {e:'⏱️',t:'When they fire',d:'If twists are on, the game schedules 1 to 3 random twists based on player count.'},
    {e:'🧠',t:'How they feel',d:'Twists can happen before word reveals or during the question phase, and the picker avoids obvious repeats when possible.'},
