...
function openSettings(){getAudio();playSound('settings');const modal=document.getElementById('settings-modal');modal.classList.remove('hidden');if(window.refreshWiggles) window.refreshWiggles(modal);}
