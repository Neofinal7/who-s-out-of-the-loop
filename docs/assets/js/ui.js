...
const _GLOW_SWEEP_RGBS=Object.freeze({
 neutral:'255,255,255',
 pink:'255,88,173',
 blue:'90,170,255',
 green:'90,230,140',
...
function _buildGlowSweepSvg(rgb){
 return `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 192 120' preserveAspectRatio='none'><defs><radialGradient id='top' cx='50%' cy='50%' r='50%'><stop offset='0%' stop-color='rgb(255,255,255)' stop-opacity='.16'/><stop offset='26%' stop-color='rgb(255,255,255)' stop-opacity='.08'/><stop offset='68%' stop-color='rgb(255,255,255)' stop-opacity='0'/></radialGradient><radialGradient id='bottom' cx='50%' cy='50%' r='50%'><stop offset='0%' stop-color='rgb(${rgb})' stop-opacity='.14'/><stop offset='28%' stop-color='rgb(${rgb})' stop-opacity='.06'/><stop offset='70%' stop-color='rgb(${rgb})' stop-opacity='0'/></radialGradient><linearGradient id='beam' x1='0%' y1='50%' x2='100%' y2='50%'><stop offset='33%' stop-color='rgb(${rgb})' stop-opacity='0'/><stop offset='39%' stop-color='rgb(${rgb})' stop-opacity='.03'/><stop offset='44%' stop-color='rgb(${rgb})' stop-opacity='.11'/><stop offset='50%' stop-color='rgb(255,255,255)' stop-opacity='.24'/><stop offset='56%' stop-color='rgb(${rgb})' stop-opacity='.13'/><stop offset='61%' stop-color='rgb(${rgb})' stop-opacity='.03'/><stop offset='67%' stop-color='rgb(${rgb})' stop-opacity='0'/></linearGradient></defs><ellipse cx='96' cy='24' rx='88.32' ry='34.8' fill='url(#top)'/><ellipse cx='96' cy='96' rx='84.48' ry='38.4' fill='url(#bottom)'/><rect x='0' y='0' width='192' height='120' fill='url(#beam)'/></svg>`;
}
function _installGlowSweepTextures(){
 const rootStyle=document.documentElement&&document.documentElement.style;
 if(!rootStyle||rootStyle.getPropertyValue('--glow-sweep-neutral-image')) return;
 for(const [name,rgb] of Object.entries(_GLOW_SWEEP_RGBS)){
  const dataUri=`url("data:image/svg+xml,${encodeURIComponent(_buildGlowSweepSvg(rgb))}")`;
  rootStyle.setProperty(`--glow-sweep-${name}-image`,dataUri);
 }
}
